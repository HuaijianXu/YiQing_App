...
//    private EditText et_data_upass;
    ...
    private void requestGet(HashMap<String, String> paramsMap) {
        try {
            String baseUrl = "http://101.200.132.210/YiQing/PaquServlet?";
    ...
    private void requestPost(HashMap<String, String> paramsMap) {
        try {
            String baseUrl = "http://101.200.132.210/YiQing/SearchServlet?method=province";
            //合成参数
            StringBuilder tempParams = new StringBuilder();
            int pos = 0;
            for (String key : paramsMap.keySet()) {
...
//            urlConn.setRequestProperty("Content-Type", "application/json");//post请求不能设置这个
    ...
    private void requestPost2(HashMap<String, String> paramsMap) {
        try {
            String baseUrl = "http://101.200.132.210/YiQing/SearchServlet?method=country";
            //合成参数
            StringBuilder tempParams = new StringBuilder();
            int pos = 0;
            for (String key : paramsMap.keySet()) {
